    ...
    var Criteria = /** @class */ (function () {
        function Criteria(table, opts, topGroup, index, depth) {
            ...
            this.dom = {
                ...
                delete: $$2("<button/>")
                    .html(
                        this.s.dt.i18n("searchBuilder.delete", i18n["delete"]),
                    )
        ...
        Criteria.prototype._adjustCriteria = function () {
            ...
            if (
                outmostval !== undefined &&
                this.dom.container.has(outmostval[0]).length !== 0
            ) {
            ...
            var hasRight =
                this.dom.container.has(this.dom.right[0]).length !== 0;
        ...
        Criteria.prototype._populateCondition = function () {
            ...
            if (conditionsLength === 0) {
                ...
                if (this.s.type === null || this.s.type === undefined) {
                    $$2.fn.dataTable.ext.oApi._fnColumnTypes(
            ...
            if (this.s.dataPoints.length === 0) {
                this.s.dt.columns().every(function (index) {
                    ...
                    if (
                        ...
                        var found = false;
                        for (
                            var _i = 0, _a = _this.s.dataPoints;
                            _i < _a.length;
                            _i++
                        ) {
                            var val = _a[_i];
        ...
        Criteria.luxonDateConditions = {
            "=": {
                ...
                search: function (value, comparison, that) {
                    return (
                        luxon.DateTime.fromFormat(value, that.s.dateFormat)
                            .ts ===
        ...
        SearchBuilder.prototype._setUp = function (loadState) {
            ...
            if (!dataTable.DateTime) {
                ...
                if (
                    ...
                    $.fn.dataTable.ext.oApi._fnColumnTypes(
                        this.s.dt.settings()[0],
                    );
