...
(function (global, factory) {
    ...
    var show = function show(stepperNode, indexStep, options, done) {
        ...
        if (
            ...
            stepper._stepsContents[indexStep].classList.contains(
                ClassName.ACTIVE,
            )
        ) {
            return;
        ...
        (function () {
                ...
                this._steps
                    ...
                    .forEach(function (step) {
                        _this._stepsContents.push(
                            _this._element.querySelector(
                                step.getAttribute("data-target"),
                            ),
                        );
                    });
            ...
            _proto._setLinkListeners = function _setLinkListeners() {
                ...
                this._steps.forEach(function (step) {
                    var trigger = step.querySelector(
                        _this2.options.selectors.trigger,
                    );

                    if (_this2.options.linear) {
                        _this2._clickStepLinearListener =
                            buildClickStepLinearListener(_this2.options);
            ...
            _proto.to = function to(stepNumber) {
                ...
                var nextStep =
                    tempIndex >= 0 && tempIndex < this._steps.length
                        ? tempIndex
                        : 0;
                show(this._element, nextStep, this.options, function () {
            ...
            _proto.destroy = function destroy() {
                ...
                this._steps.forEach(function (step) {
                    var trigger = step.querySelector(
                        _this7.options.selectors.trigger,
                    );
