                    ...
                    _createClass(
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                set: function set(value) {
                                    this._format =
                                        ColorItem.sanitizeFormat(value);
                                },
                            },
                        ],
                        [
                    ...
                    _createClass(Palette, [
                        {
                            ...
                            value: function getLength() {
                                ...
                                if (_typeof(this.options.colors) === "object") {
                                    return Object.keys(this.options.colors)
                                        .length;
                                }
                        ...
                        },
                        {
                            ...
                            value: function resolveColor(color) {
                                ...
                                if (Array.isArray(this.options.colors)) {
                                    if (
                                        this.options.colors.indexOf(color) >= 0
                                    ) {
                                        return color;
                                    }
                                    if (
                    ...
                    var $elements = this.each(function () {
                        ...
                        if (typeof option === "string") {
                            if (option === "colorpicker") {
                                ...
                                _jquery2.default.isFunction(inst[option])
                            ) {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Colorpicker = (function () {
                    ...
                    function Colorpicker(element, options) {
                         ...
                         * @type {PopupHandler}
                         */
                        this.popupHandler = new _PopupHandler2.default(
                            this,
                            root,
                        );
                        /**
                ...
                var SliderHandler = (function () {
                    ...
                    _createClass(SliderHandler, [
                        ...
                        },
                        {
                            key: "bind",
                            value: function bind() {
                                var sliders = this.colorpicker.options
                                    .horizontal
                    ...
                    _createClass(InputHandler, [
                        ...
                        },
                        {
                            ...
                            value: function getFormattedColor() {
                                ...
                                if (
                                    this.colorpicker.options.useHashPrefix ===
                                    false
                                ) {
                                    val = val.replace(/^#/g, "");
                                }
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                Color.prototype = {
                    ...
                    string: function (places) {
                        var self =
                            this.model in colorString.to ? this : this.rgb();
                        self = self.round(
                ...
                cs.get.rgb = function (string) {
                    ...
                    if ((match = string.match(hex))) {
                        ...
                        if (hexAlpha) {
                            rgb[3] =
                                Math.round(
                                    (parseInt(hexAlpha + hexAlpha, 16) / 255) *
                                        100,
                                ) / 100;
                        }
                    ...
                    _createClass(ColorHandler, [
                        ...
                        },
                        {
                            ...
                            value: function isInvalidColor() {
                                return (
                                    !this.hasColor() || !this.color.isValid()
                                );
                            },
                        ...
                        },
                        {
                            ...
                            value: function isAlphaEnabled() {
                                return (
                                    this.colorpicker.options.useAlpha !== false
                                );
                            },
                        ...
                        },
                        {
                            ...
                            value: function hasColor() {
                                return (
                                    this.color instanceof _ColorItem2.default
                                );
                            },
                        },
                        {
                    ...
                    _createClass(PickerHandler, [
                        {
                            ...
                            value: function bind() {
                                ...
                                _jquery2.default)(this.options.template));
                            ...
                            value: function update() {
                                ...
                                if (saturationGuide.length) {
                                    saturationGuide.css({
                                        ...
                                        left:
                                            hsva.s * slider.saturation.maxLeft,
                                    });
                                }
