...
(function ($) {
    ...
    function initTouchNavigation(plot, options) {
        ...
        function shutdown(plot, eventHolder) {
            ...
            eventHolder[0].removeEventListener(
                "doubletap",
                doubleTap.recenterPlot,
            );
        }
        ...
        pan = {
            start: function (e) {
                ...
                if (useSmartPan) {
                    ...
                    navigationState.initialState = plot.navigationState(
                        point.x,
                        point.y,
                    );
                }
            ...
            drag: function (e) {
                ...
                if (useSmartPan) {
                    ...
                    plot.smartPan(
                        {
                            x:
                                navigationState.initialState.startPageX -
                                point.x,
                            y:
                                navigationState.initialState.startPageY -
                                point.y,
                        },
            ...
            drag: function (e) {
                ...
                pinchDragTimeout = setTimeout(function () {
                    ...
                    if (
                        ...
                        Math.abs(dist - gestureState.prevDistance) >
        ...
        function presetNavigationState(e, gesture, gestureState) {
            navigationState.touchedAxis = getAxis(
                plot,
                e,
                gesture,
                navigationState,
    ...
    function checkAxesForDoubleTap(plot, e, navigationState) {
        ...
        axis = plot.getTouchedAxis(
            e.detail.secondTouch.x,
            e.detail.secondTouch.y,
        );
        if (axis[0] !== undefined) {
    ...
    function noAxisTouched(navigationState) {
        return (
            !navigationState.touchedAxis ||
            navigationState.touchedAxis.length === 0
        );
    }
    ...
    function updatePrevPanPosition(e, gesture, gestureState, navigationState) {
        ...
        switch (navigationState.navigationConstraint) {
            ...
            case "axisConstrained":
                gestureState.prevPanPosition[
                    navigationState.currentTouchedAxis
