                ...
                [
                    ...
                    },
                    {
                        ...
                        value: function navigateTo(index) {
                            if (
                                index < 0 ||
                                index > this._$galleryItems.length - 1
                            )
                                return this;
                    ...
                    },
                    {
                        ...
                        value: function updateNavigation() {
                            if (!this._config.wrapping) {
                                ...
                                if (this._galleryIndex === 0)
                                    $nav.find("a:first-child").addClass(
                                        "disabled",
                                    );
                                else
                                ...
                                if (
                                    ...
                                    $nav.find("a:last-child").addClass(
                                        "disabled",
                                    );
                                else
                                    $nav.find("a:last-child").removeClass(
                                        "disabled",
                                    );
                            }
                        },
                            ...
                            switch (currentType) {
                                ...
                                case "vimeo":
                                    this._showVimeoVideo(
                                        this._getVimeoId(currentRemote),
                                        $toUse,
                                    );
                                    break;
                                case "instagram":
                    ...
                    },
                    {
                        ...
                        value: function _getYoutubeId(string) {
                            ...
                            return matches && matches[2].length === 11
                                ? matches[2]
                                : false;
                        },
                    },
                    {
                        ...
                        value: function _getVimeoId(string) {
                            return string && string.indexOf("vimeo") > 0
                                ? string
                                : false;
                        },
                    },
                    {
                        ...
                        value: function _getInstagramId(string) {
                            return string && string.indexOf("instagram") > 0
                                ? string
                                : false;
                        },
                    ...
                    },
                    {
                        ...
                        value: function _totalCssByAttribute(attribute) {
                            return (
                                parseInt(
                                    this._$modalDialog.css(attribute),
                                    10,
                                ) +
                                parseInt(
                                    this._$modalContent.css(attribute),
                                    10,
                                ) +
                    ...
                    },
                    {
                        ...
                        value: function _showYoutubeVideo(
                            remote,
                            $containerForElement,
                        ) {
                    ...
                    {
                        key: "_showVimeoVideo",
                        value: function _showVimeoVideo(
                            id,
                            $containerForElement,
                        ) {
                    ...
                    },
                    {
                        ...
                        value: function _showInstagramVideo(
                            id,
                            $containerForElement,
                        ) {
                    ...
                    {
                        key: "_showHtml5Video",
                        value: function _showHtml5Video(
                            url,
                            $containerForElement,
                        ) {
                            // should be used for videos only. for remote content use loadRemoteContent (data-type=url)
                    ...
                    },
                    {
                        ...
                        value: function _loadRemoteContent(
                            url,
                            $containerForElement,
                        ) {
                            var _this3 = this;
                            ...
                            var disableExternalCheck =
                                this._$element.data("disableExternalCheck") ||
                                false;
                            this._toggleLoading(false);
                            ...
                            if (
                                ...
                                !this._isExternal(url)
                            ) {
                                $containerForElement.load(
                                    url,
                                    $.proxy(function () {
                                        return _this3._$element.trigger(
                                            "loaded.bs.modal",
                                        );
                                        l;
                                    }),
                    ...
                    },
                    {
                        ...
                        value: function _preloadImageByIndex(
                            startIndex,
                            numberOfTimes,
                        ) {
                            if (!this._$galleryItems) return;
                            ...
                            var next = $(
                                this._$galleryItems.get(startIndex),
                                false,
                            );
                            if (typeof next == "undefined") return;

                            var src =
                                next.attr("data-remote") || next.attr("href");
                            if (
                                next.attr("data-type") === "image" ||
                                this._isImage(src)
                            )
                            ...
                            if ($containerForImage) {
                                (function () {
                                    ...
                                    var loadingTimeout = setTimeout(
                                        function () {
                                            $containerForImage.append(
                                                _this4._config.loadingMessage,
                                            );
                                        },
                                        200,
                                    );
                                    ...
                                    img.onload = function () {
                                        ...
                                        return _this4._config.onContentLoaded.call(
                                            _this4,
                                        );
                                    };
                    ...
                    },
                    {
                        ...
                        value: function _resize(width, height) {
                            ...
                            var addMargin =
                                this._config.doc.body.clientWidth > 575
                                    ? 20
                                    : 0;
                            var discountMargin =
                                this._config.doc.body.clientWidth > 575
                            ...
                            if (this._footerIsShown)
                                footerHeight =
                                    this._$modalFooter.outerHeight(true) || 55;

                            if (this._titleIsShown)
                                headerHeight =
                                    this._$modalHeader.outerHeight(true) || 67;
                            ...
                            var margins =
                                parseFloat(
                                    this._$modalDialog.css("margin-top"),
                                ) +
                                parseFloat(
                                    this._$modalDialog.css("margin-bottom"),
                                );
