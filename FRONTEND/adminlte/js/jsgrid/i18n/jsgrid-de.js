(function (jsGrid) {
    jsGrid.locales.de = {
        ...
        validators: {
            ...
            rangeLength: {
                message:
                    "Die Länge der Eingabe liegt außerhalb des zulässigen Bereichs",
            },
            minLength: { message: "Die Eingabe ist zu kurz" },
            maxLength: { message: "Die Eingabe ist zu lang" },
            pattern: {
                message: "Die Eingabe entspricht nicht dem gewünschten Muster",
            },
            range: {
                message:
                    "Der eingegebene Wert liegt außerhalb des zulässigen Bereichs",
            },
