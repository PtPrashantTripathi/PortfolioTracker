(function (jsGrid) {
    jsGrid.locales["pt-br"] = {
        ...
        validators: {
            ...
            rangeLength: {
                message: "O valor esta fora do intervaldo definido",
            },
            minLength: { message: "O comprimento do valor é muito curto" },
            maxLength: { message: "O comprimento valor é muito longo" },
            pattern: {
                message: "O valor informado não é compatível com o padrão",
            },
            range: {
                message: "O valor informado esta fora do limite definido",
            },
