...
(function (factory) {
    ...
    $.extend(Scroller.prototype, {
        ...
        pageInfo: function () {
            ...
            return {
                start: Math.floor(
                    this.pixelsToRow(iScrollTop, false, this.s.ani),
                ),
        ...
        _domain: function (dir, val) {
            ...
            if (val < magic) {
                ...
                dir === "physicalToVirtual" &&
                val >= heights.scroll - magic
            ) {
