...
(function (factory) {
    ...
    $.extend(AutoFill.prototype, {
        ...
        _drawSelection: function (target, e) {
            ...
            height =
                this._getPosition(bottom.get(0)).top +
                bottom.outerHeight() -
                top;
            width =
                this._getPosition(right.get(0)).left +
                right.outerWidth() -
                left;
        ...
        _focusListener: function () {
            ...
            if (focus === "focus") {
                ...
                $(document.body).on("click" + namespace, function (e) {
                    if (
                        !$(e.target).parents().filter(dt.table().body()).length
                    ) {
                        that._detach();
                    }
                });
        ...
        _getPosition: function (node, targetParent) {
            ...
            do {
                ...
                left +=
                    positionLeft +
                    parseInt(currOffsetParent.css("border-left-width") || 0) *
                        1;
                ...
                selected.push(
                    $.map(columns, function (column) {
                        ...
                        if (editField !== undefined) {
                            data = dtSettings.oApi._fnGetObjectDataFn(
                                editField,
