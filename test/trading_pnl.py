...
def trade_pnl_amount(input_file):
...
if __name__ == "__main__":
    print(
        "OPEN_TIME,CLOSE_TIME,SYMBOL,QUANTITY,PNL_AMOUNT,OPEN_SIDE,CLOSE_SIDE,OPEN_PRICE,CLOSE_PRICE"
    )
    print(trade_pnl_amount(input_csv))
