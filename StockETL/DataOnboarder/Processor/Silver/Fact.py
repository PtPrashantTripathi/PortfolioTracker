...
class SilverFactProcessor(BaseProcessor):
    """Silver Fact Processor"""
    ...
    def load(self) -> None:
        ...
        success_message = f"{self.__repr__} - {self.meta_data['save_mode']} COMPLETE to {self.meta_data['database']['schema']}"
        logger.info(success_message)

    def __repr__(self) -> str:
        return f"Processor - Silver - Fact"
